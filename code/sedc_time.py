# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 10:34:26 2020

@author: TVermeire
"""

def sedc_time(image, classifier, segments, mode, time_limit=15):
    import time
    import numpy as np
    import cv2
    ...
    return explanation, segments_in_explanation, perturbation, new_class, too_long             
