...
# Import cats
path_images = 'C:/Users/tvermeire/Dropbox/Images/beacons/'
...
correct_class = np.argwhere(imagenet_labels == 'beacon')[0][0]
...
class_of_interest = np.argwhere(imagenet_labels == 'missile')[0][0]
...
image = misclassifications_focus[3]
plt.imshow(image)
from sedc_t2 import sedc_t2
segments = quickshift(image, kernel_size=4, max_dist=200, ratio=0.2)
plt.imshow(mark_boundaries(image, segments))
explanation, segments_in_explanation, perturbation, new_class = sedc_t2(image, classifier, segments, correct_class, 'inpaint')
