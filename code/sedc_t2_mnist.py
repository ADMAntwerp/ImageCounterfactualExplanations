# -*- coding: utf-8 -*-
"""
Created on Mon Sep 14 14:09:40 2020
...
def sedc_t2_mnist(image, classifier, segments, target_class, mode):
    ...
    if mode == 'mean':
        perturbed_image = np.zeros((28,28,3))
        ...
        perturbed_image = np.random.random((28,28,3))
    elif mode == 'black':
        perturbed_image = np.zeros((28,28,3))
        perturbed_image[:,:,0] = 0
        perturbed_image[:,:,1] = 0
