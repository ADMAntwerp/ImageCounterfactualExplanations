...
path = r'C:\Users\tvermeire\Dropbox\Doctoraat\Applied Data Mining\XAI images\Spyder\misclassifications_experiment\\Experiment 1 - best first target increase'
...
for class_name in classes: 
    ...
    # Create directory
    os.chdir(r'C:\Users\tvermeire\Dropbox\Doctoraat\Applied Data Mining\XAI images\Spyder\misclassifications_experiment')
    os.mkdir(class_name)
    os.chdir(r'C:\Users\tvermeire\Dropbox\Doctoraat\Applied Data Mining\XAI images\Spyder')
    ...
    for label in labels_ordered[0:number_of_classes]:
        ...
        # Output figure
        os.chdir('C:/Users/tvermeire/Dropbox/Doctoraat/Applied Data Mining/XAI images/Spyder/misclassifications_experiment/'+ class_name)
